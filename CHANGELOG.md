...
- [breaking] Removed `.o-breadcrumbs__root`. Define it in your own stylesheets.
...
- [breaking] Fixed wrongly named `.o-breadcrumb`, renamed to `.o-breadcrumbs`.
- [breaking] Fixed wrongly named `.o-breadcrumbs` related variables. Now they all end on `s`.
...
- [breaking] Renamed oddly named `.o-breadcrumbs__entry` to more common `.o-breadcrumbs__item`.